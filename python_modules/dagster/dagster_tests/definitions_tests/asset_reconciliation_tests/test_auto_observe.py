...
Scenarios
- Single observable source asset
- Single observable source asset without policy
- Non-observable source asset
- Two observable source assets in same repo on same frequency
- Two observable source assets in same repo on different frequencies
- Two observable source assets in different repo
"""
