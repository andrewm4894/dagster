...
def get_auto_observe_run_requests(
    ...
    assets_to_auto_observe: List[AssetKey] = []
    for asset_key in asset_graph.source_asset_keys:
        ...
        if auto_observe_interval_minutes and (
            ...
            assets_to_auto_observe.append(asset_key)

    # TODO: split by repo
    if assets_to_auto_observe:
        return [RunRequest(asset_selection=assets_to_auto_observe)]
    else:
        return []
