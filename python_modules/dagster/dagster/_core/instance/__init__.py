...
class DagsterInstance(DynamicPartitionsStore):
    ...
    def ephemeral(
        ...
        """Create a DagsterInstance suitable for ephemeral execution, useful in test contexts.
    ...
    def local_temp(
        ...
        """Create a DagsterInstance that uses a temp dir for local storage.
    ...
    def delete_run(self, run_id: str) -> None:
        """Delete a run from the run storage.
